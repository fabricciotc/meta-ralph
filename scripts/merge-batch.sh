#!/bin/bash
# Mergea un batch de workers al trunk mediante cherry-pick
# Uso: merge-batch.sh <batch_id> [task_id1] [task_id2] ...
...
for TASK_ID in "$@"; do
  ...
  if [ -z "$LAST_COMMIT" ]; then
    # Intentar obtener último commit de la branch
